    ...
    <div className='register'>
        ...
        <div className='register-container'>
            ...
            <form>
                ...
                <center>
                    <div className='row'>
                        <input type='name' value={firstName} onChange={(e) => {setFirstName(e.target.value)}} className='register-name' placeholder='First Name' />
                        <input type='name' value={lastName} onChange={(e) => {setLastName(e.target.value)}} className='register-name' placeholder='Surname' />
                    </div>
                </center>
                <center>
                ...
                <h4 className='register-date'>Date of Birth</h4>
                <div className='row2'>
                    <select className='register-date1' onChange={(e) => setBirthday([...birthday, e.target.value])}>
                    ...
                    <select className='register-date2' onChange={(e) => setBirthday([...birthday, e.target.value])}>
                ...
                <div value={gender} className='register-radio'>
                    ...
                    <div className='wrapper'>
                        <label>Custom</label>
                        <input onChange={(e) => setGender(e.target.value)} type='radio' name='gender' value='Custom' />
                    </div>
                </div>
                ...
                <center>
                    <Link to='/login' style={{textDecoration: 'none'}}><h6 className='register-login'>Already have an account?</h6></Link>
                </center>
